...
<?php $component->withAttributes([]); ?>
    ...
    <section id="hero-animation">
        <div id="landingHero" class="section-py landing-hero position-relative">
            <img src="<?php echo e(asset_index('img/front-pages/backgrounds/hero-bg.png')); ?>"
                alt="hero background"
            ...
            <div class="container">
                <div class="hero-text-box text-center position-relative">
                    <h1 class="text-primary hero-title display-6 fw-extrabold">
                        <?php echo e(__index('BOOST_MPWA')); ?>

                    </h1>
                    <h2 class="hero-sub-title h6 mb-6">
                        <?php echo e(__index('BOOST_MPWA_MSG')); ?>.
                    </h2>
                    <div class="landing-hero-btn d-inline-block position-relative">
                        <span class="hero-btn-item position-absolute d-none d-md-flex fw-medium"><?php echo e(__index('CHOOSE_PLAN')); ?>

                            <img src="<?php echo e(asset_index('img/front-pages/icons/Join-community-arrow.png')); ?>"
                                alt="Join community arrow" class="scaleX-n1-rtl" /></span>
                        <a href="#features" class="btn btn-primary btn-lg"><?php echo e(__index('FEATURES')); ?></a>
                    </div>
                </div>
                <div id="heroDashboardAnimation" class="hero-animation-img">
                    <a href="<?php echo e(route('login')); ?>" target="_blank">
						<div id="heroAnimationImg" class="position-relative hero-dashboard-img">
						  <img
							src="<?php echo e(asset_index('img/front-pages/landing-page/hero-dashboard-light.png')); ?>"
							alt="hero dashboard"
							class="animation-img"
							data-app-light-img="front-pages/landing-page/hero-dashboard-light.png"
							data-app-dark-img="front-pages/landing-page/hero-dashboard-dark.png" />
						  <img
							src="<?php echo e(asset_index('img/front-pages/landing-page/hero-elements-light.png')); ?>"
							alt="hero elements"
    ...
    <section id="features" class="section-py landing-features">
        <div class="container">
            <div class="text-center mb-4">
                <span class="badge bg-label-primary"><?php echo e(__index('USEFUL_FEATURES')); ?></span>
            </div>
            <h4 class="text-center mb-1">
				<span class="position-relative fw-extrabold z-1"><?php echo e(__index('EVERYTHING_YOU_NEED')); ?>

					<img src="<?php echo e(asset_index('img/front-pages/icons/section-title-icon.png')); ?>"
						alt="MPWA icon"
						class="section-title-img position-absolute object-fit-contain bottom-0 z-n1" />
				</span>
				<?php echo e(__index('TO_LAUNCH_YOUR_WHATSAPP_GATEWAY')); ?>

			</h4>
			<p class="text-center mb-12">
				<?php echo e(__index('MPWA_IS_NOT_JUST')); ?>
            ...
            <div class="features-icon-wrapper row gx-0 gy-6 g-sm-12">
                <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                    ...
                    <h5 class="mb-2"><?php echo e(__index('AI_REPLY')); ?></h5>
                    <p class="features-icon-description">
                        <?php echo e(__index('AI_REPLY_MSG')); ?>
                ...
                <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                    ...
                    <h5 class="mb-2"><?php echo e(__index('TEMPLATE_MESSAGING')); ?></h5>
                    <p class="features-icon-description">
                        <?php echo e(__index('TEMPLATE_MESSAGING_MSG')); ?>
                ...
                <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                    ...
                    <h5 class="mb-2"><?php echo e(__index('AUTO_REPLY')); ?></h5>
                    <p class="features-icon-description">
                        <?php echo e(__index('AUTO_REPLY_MSG')); ?>
                ...
                <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                    ...
                    <h5 class="mb-2"><?php echo e(__index('API_READY')); ?></h5>
					<p class="features-icon-description">
						<?php echo e(__index('CONNECT_INSTANTLY')); ?>
                ...
                <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                    ...
                    <h5 class="mb-2"><?php echo e(__index('ACTIONS_BUTTONS')); ?></h5>
                    <p class="features-icon-description">
                        <?php echo e(__index('ACTIONS_BUTTONS_MSG')); ?>
                ...
                <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                    ...
                    <h5 class="mb-2"><?php echo e(__index('WELL_DOCUMENTED')); ?></h5>
					<p class="features-icon-description">
						<?php echo e(__index('COMPREHENSIVE_DEVELOPER_FRIENDLY')); ?>
    ...
    <section id="pricing" class="section-py bg-body landing-pricing">
        <div class="container">
            <div class="text-center mb-4">
                <span class="badge bg-label-primary"><?php echo e(__index('CHOOSE_PLAN')); ?></span>
            </div>
            <h4 class="text-center mb-1">
                <span class="position-relative fw-extrabold z-1"><?php echo e(__index('GATEWAY_PRICING')); ?>

                    <img src="<?php echo e(asset_index('img/front-pages/icons/section-title-icon.png')); ?>"
                        alt="laptop charging"
                        class="section-title-img position-absolute object-fit-contain bottom-0 z-n1" />
                </span>
                <?php echo e(__index('DESIGNED_FOR_YOU')); ?>

            </h4>
            <p class="text-center pb-2 mb-7">
                <?php echo e(__index('CHOOSE_PLAN_MSG')); ?>
            ...
            <div class="row g-6 pt-lg-5 justify-content-center">
                ...
                <div class="col-xl-4 col-lg-6">
                    <div class="card <?php echo e($plan->is_recommended == 1 ? 'border border-primary shadow-xl' : ''); ?>">
                        <div class="card-header">
                            <div class="text-center">
                                <h4 class="mb-0"><?php echo e($plan->title); ?></h4>
                                <div class="d-flex align-items-center justify-content-center">
                                    <span class="price-monthly h2 text-primary fw-extrabold mb-0">
                                        <b><sup class="h4 me-2 fw-bold"><?php echo e($plan->symbol); ?></sup><?php echo e(number_format($plan->price)); ?></b>
                                    </span>
                                </div>
                                <div class="position-relative pt-2">
                                    <div class="price-yearly text-body-secondary price-yearly-toggle start-0 end-0">
                                        <?php echo e($plan->days); ?> <?php echo e(__index('DAYS')); ?>
                        ...
                        <div class="card-body">
                            <ul class="list-unstyled pricing-list">
                                ...
                                <li>
                                    <h6 class="d-flex align-items-center mb-3">
                                        <span
                                            class="badge badge-center rounded-pill <?php echo e($data == false ? 'bg-label-danger' : 'bg-label-primary'); ?> p-0 me-3">
                                            <i
                                                class="icon-base ti <?php echo e($data == false ? 'tabler-x' : 'tabler-check'); ?> icon-12px"></i>
                                        </span>
                                        <?php echo e(__index(strtoupper($key))); ?>

                                        <?php if($key == 'messages_limit' || $key == 'device_limit'): ?>
                                        (<?php echo e(number_format($data)); ?>)
                                        <?php endif; ?>
                                    </h6>
                                </li>
                            ...
                            <div class="d-grid mt-8">
                                ...
                                <a href="<?php echo e(route('payments.trial', $plan->id)); ?>"
                                    class="mt-2 btn <?php echo e($plan->is_recommended == 1 ? 'btn-danger' : 'btn-label-primary'); ?>">
                                    <?php echo e(__index('TRIAL_DAYS', ['trial_days' => $plan->trial_days])); ?>
	...
	<!-- CTA: Start -->
      <section id="landingCTA" class="section-py landing-cta position-relative p-lg-0 pb-0">
        <img
          src="<?php echo e(asset_index('img/front-pages/backgrounds/cta-bg-light.png')); ?>"
        ...
        <div class="container">
          <div class="row align-items-center gy-12">
            <div class="col-lg-6 text-start text-sm-center text-lg-start">
              <h3 class="cta-title text-primary fw-bold mb-1"><?php echo e(__index('GET_STARTED')); ?></h3>
              <h5 class="text-body mb-8"><?php echo e(__index('START_YOUR_PLANS')); ?></h5>
              <a href="#pricing" class="btn btn-lg btn-primary"><?php echo e(__index('BUY_NOW')); ?></a>
            </div>
            <div class="col-lg-6 pt-lg-12 text-center text-lg-end">
              <img
                src="<?php echo e(asset_index('img/front-pages/landing-page/cta-dashboard.png')); ?>"
                alt="cta dashboard"
    ...
    <section id="contact" class="section-py bg-body landing-contact">
        <div class="container">
            <div class="text-center mb-4">
                <span class="badge bg-label-primary"><?php echo e(__index('CONTACT_US')); ?></span>
            </div>
            <p class="text-center mb-12 pb-md-4">
                <?php echo e(__index('CONTACT_US_MSG')); ?>

            </p>
            <div class="row g-6 justify-content-center">
                <div class="col-lg-5">
                    <div class="contact-img-box position-relative border p-2 h-100">
                        <img src="<?php echo e(asset_index('img/front-pages/icons/contact-border.png')); ?>"
                            alt="contact border"
                            class="contact-border-img position-absolute d-none d-lg-block scaleX-n1-rtl" />
                        <img src="<?php echo e(asset_index('img/front-pages/landing-page/contact-customer-service.png')); ?>"
                            ...
                            <div class="row g-4">
                                <div class="col-md-6 col-lg-12 col-xl-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <p class="mb-0"><?php echo e(__index('EMAIL')); ?></p>
                                            <h6 class="mb-0">
                                                <a href="mailto:<?php echo e(__index('FOOTER_EMAIL')); ?>" class="text-heading">
                                                    <?php echo e(__index('FOOTER_EMAIL')); ?>
                                ...
                                <div class="col-md-6 col-lg-12 col-xl-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <p class="mb-0"><?php echo e(__index('PHONE')); ?></p>
                                            <h6 class="mb-0">
                                                <a href="tel:<?php echo e(__index('FOOTER_PHONE')); ?>" class="text-heading">
                                                    <?php echo e(__index('FOOTER_PHONE')); ?>
                                ...
                                <div class="col-md-6 col-lg-12 col-xl-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <p class="mb-0"><?php echo e(__index('HOURS')); ?></p>
                                            <h6 class="mb-0">
                                                <?php echo e(__index('FOOTER_CLOCK')); ?>
                                ...
                                <div class="col-md-6 col-lg-12 col-xl-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <p class="mb-0"><?php echo e(__index('ADDRESS')); ?></p>
                                            <h6 class="mb-0">
                                                <?php echo e(__index('FOOTER_MAP')); ?>
                ...
                <div class="col-lg-7">
                    <div class="card h-100">
                        <div class="card-body">
                            <h4 class="mb-2"><?php echo e(__index('SEND_A_MESSAGE')); ?></h4>
                            <p class="mb-6">
                                <?php echo e(__index('ANY_QUESTION')); ?>
                            ...
                            <form method="post" name="myForm" onsubmit="return validateForm()">
                                ...
                                <div class="row g-4">
                                    <div class="col-md-6">
                                        <label class="form-label" for="contact-form-fullname"><?php echo e(__index('NAME')); ?></label>
                                        <input name="name" id="contact-form-fullname" type="text" class="form-control"
                                            placeholder="<?php echo e(__index('NAME')); ?>..." />
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label" for="contact-form-email"><?php echo e(__index('EMAIL')); ?></label>
                                        <input name="email" id="contact-form-email" type="email" class="form-control"
                                            placeholder="<?php echo e(__index('EMAIL')); ?>..." />
                                    </div>
                                    <div class="col-12">
                                        <label class="form-label" for="contact-form-message"><?php echo e(__index('MESSAGE')); ?></label>
                                        <textarea name="comments" id="contact-form-message" rows="7"
                                            class="form-control" placeholder="<?php echo e(__index('MESSAGE')); ?>..."></textarea>
                                    </div>
                                    <div class="col-12">
                                        <button type="submit" id="submit" name="send" class="btn btn-primary">
                                            <?php echo e(__index('SEND_MESSAGE')); ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\whatsapp\resources\index/vuexy/views/home.blade.php ENDPATH**/ ?>