<div class="tab-pane fade show active" id="textmessage" role="tabpanel">
	<form class="row g-3" action="<?php echo e(route('messagetest')); ?>" method="POST">
		...
		<textarea id="inputText" name="message" placeholder="<?php echo e(__('Example : {Hi|Hello} your number is {number}')); ?>" class="form-control" cols="30" rows="15" required></textarea>
...
<script type="module" src="<?php echo e(asset('js/text.js')); ?>?v=<?php echo e(config('app.version')); ?>"></script>
<script type="module" src="<?php echo e(asset('js/emoji/picker.min.js')); ?>?v=<?php echo e(config('app.version')); ?>"></script><?php /**PATH C:\laragon\www\whatsapp\resources\themes/vuexy/views/ajax/test/formtext.blade.php ENDPATH**/ ?>