<div class="tab-pane fade show" id="productmessage" role="tabpanel">
    <form class="row g-3" action="<?php echo e(route('messagetest')); ?>" method="POST">
		...
		<div class="col-md-12 position-relative">
			<label class="form-label"><?php echo e(__('WhatsApp Product URL')); ?></label>
		...
		<div class="col-12">
            ...
            <label class="form-label"><?php echo e(__('Message *optional')); ?></label>
...
</div><?php /**PATH C:\laragon\www\whatsapp\resources\themes/vuexy/views/ajax/test/formproduct.blade.php ENDPATH**/ ?>